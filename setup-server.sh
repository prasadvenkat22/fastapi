...
# Usage: curl -sSL https://raw.githubusercontent.com/prasadvenkat22/fastapi/main/setup-server.sh | bash
# Or: wget -qO- https://raw.githubusercontent.com/prasadvenkat22/fastapi/main/setup-server.sh | bash
...
JWT_ALGORITHM=RS256
CLIENT_ORIGIN=${DOMAIN:-http://$(curl -s ifconfig.me)}
